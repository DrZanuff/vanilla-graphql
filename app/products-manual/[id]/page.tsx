...
// Manual GraphQL queries using gql - no codegen
...
export default function ProductManualPage() {
  ...
  const { data, loading, error } = useQuery<{ product: Product | null }>(
    GET_PRODUCT,
    {
      variables: { id },
      skip: !id,
  ...
  // Using useMutation directly with manual typing
